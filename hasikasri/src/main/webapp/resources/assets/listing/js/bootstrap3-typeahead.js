		...
		(
				...
				function($) {
					...
					Typeahead.prototype = {
						...
						select : function() {
							...
							if (this.autoSelect || val) {
								...
								// Updater can be set to any random functions
								// via "options" parameter in constructor above.
								// Add null check for cases when upadter returns
								// void or undefined.
								if (!newVal) {
									newVal = "";
								}
					...
					$.fn.typeahead.defaults = {
						source : [],
						items : 8,
						menu : '<ul class="typeahead dropdown-menu search_items" role="listbox"></ul>',
